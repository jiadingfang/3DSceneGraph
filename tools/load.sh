project_path=/home/fjd/3DSceneGraph                  # system path to the 3D Scene Graph folder
...
# data_path=$project_path/scene_graph_data/3DSceneGraph_tiny/data                    # system path to 3D Scene Graph results
data_path=$project_path/scene_graph_data/3DSceneGraph_medium                    # system path to 3D Scene Graph results
palette_path=$project_path/tools/palette.txt    # system path to color palette (for visualization purposes)
# gibson_mesh_path=$project_path/gibson_mesh_data/gibson_tiny       # system path to Gibson database model data
gibson_mesh_path=$project_path/gibson_mesh_data/gibson_medium       # system path to Gibson database model data
